export const ContractAbi = {
	...
	ABI: [{
		...
		'constant': true,
		'inputs': [{ 'internalType': 'address', 'name': 'sourceToken', 'type': 'address' }, {
			'internalType': 'address',
			'name': 'destToken',
			'type': 'address'
		...
		'outputs': [{ 'internalType': 'uint256', 'name': 'sourceToDestSwapRate', 'type': 'uint256' }],
		'payable': false,
		'stateMutability': 'view',
		'type': 'function'
	}, {
		...
		'constant': true,
		'inputs': [{ 'internalType': 'address', 'name': 'loanToken', 'type': 'address' }, {
			'internalType': 'address',
		...
		'outputs': [{ 'internalType': 'uint256', 'name': 'currentMargin', 'type': 'uint256' }, {
			'internalType': 'uint256',
		...
		'name': 'getMaxDrawdown',
		'outputs': [{ 'internalType': 'uint256', 'name': 'maxDrawdown', 'type': 'uint256' }],
		'payable': false,
		'stateMutability': 'view',
		'type': 'function'
	}, {
		...
		'inputs': [{ 'internalType': 'address', 'name': '', 'type': 'address' }],
		'name': 'pricesFeeds',
		'outputs': [{ 'internalType': 'contract IPriceFeedsExt', 'name': '', 'type': 'address' }],
		'payable': false,
		'stateMutability': 'view',
		'type': 'function'
	}, {
		...
		'constant': false,
		'inputs': [{ 'internalType': 'contract IBEP20[]', 'name': 'tokens', 'type': 'address[]' }],
		'name': 'setDecimals',
		'outputs': [],
		'payable': false,
		'stateMutability': 'nonpayable',
		...
		'inputs': [{
			...
			'name': 'tokens',
			'type': 'address[]'
		}, { 'internalType': 'contract IPriceFeedsExt[]', 'name': 'feeds', 'type': 'address[]' }],
		'name': 'setPriceFeed',
		'outputs': [],
		'payable': false,
		'stateMutability': 'nonpayable',
		...
		'inputs': [],
		'name': 'wbnbToken',
		'outputs': [{ 'internalType': 'contract IWbnbBEP20', 'name': '', 'type': 'address' }],
		'payable': false,
		'stateMutability': 'view',
		'type': 'function'
	}]
